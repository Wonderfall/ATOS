...
:white_small_square: `{bot_prefix}dq` : se retirer du tournoi avant/après (DQ) que celui-ci ait commencé.
...
:white_small_square: `{bot_prefix}stages` : obtenir la stagelist légale actuelle.
:white_small_square: `{bot_prefix}lag` : ouvrir une procédure de lag, à utiliser avec parcimonie.
:white_small_square: `{bot_prefix}desync` : obtenir une notice d'aide en cas de desync sur Project+ - Dolphin Netplay.
...
:white_small_square: `{bot_prefix}purge` : purifier les channels relatifs à un tournoi.
...
:tv: **Commandes stream :**
:white_small_square: `{bot_prefix}stream` : obtenir toutes les informations relatives au stream (IDs, on stream, queue).
:white_small_square: `{bot_prefix}setstream` : mettre en place l'arène de stream *(2 paramètres : ID MDP)*.
:white_small_square: `{bot_prefix}addstream` : ajouter un set à la stream queue *(paramètre : n° | liste de n°)*.
:white_small_square: `{bot_prefix}rmstream` : retirer un set de la stream queue *(paramètre : n° | queue | now)*.
"""
